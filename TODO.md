- Rule::apply should return number of applications
- Should implement SimpleSaturator and Directed Saturator as wrappers for ScheduledSaturator
- Przepisać pomysły z notesu
- Compare DirectedSaturator and SimpleSaturator in main
...
- When a single e-class is a child of many expressions, it contributes a lot to the cost.
...
- Make EGraph not dependent on Analysis trait -- make it runtime polymorphism instead
