...
use verbum::rewriting::direct::var_free;
...
fn main() {
    ...
    let rewritten = var_free::rewrite(expr.clone(), &rules, 5);
    ...
    let rewritten2 = var_free::rewrite(expr2, &rules, 10);
    ...
    let rewritten3 = var_free::rewrite(expr3, &rules, 3);
