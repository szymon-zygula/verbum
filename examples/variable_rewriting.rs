...
//!
//! This example shows how to use the direct rewriter to perform
//! deterministic term rewriting on expressions that contain variables.
...
fn main() {
    ...
    let rewritten1 = direct::rewrite(expr1, &rules, 10);
    ...
    let rewritten2 = direct::rewrite(expr2, &rules, 10);
    ...
    let rewritten3 = direct::rewrite(expr3, &rules, 10);
    ...
    let rewritten4 = direct::rewrite(expr4, &rules, 10);
